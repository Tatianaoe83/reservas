<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 via-cyan-500 to-teal-500 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="max-w-md w-full space-y-8 relative z-10">
            ...
            <div class="text-center transform transition-all duration-500 hover:scale-105">
                <div class="mx-auto flex items-center justify-center h-24 w-24 rounded-full bg-white shadow-2xl mb-6 transform transition-all duration-300 hover:rotate-12 hover:shadow-blue-300">
                    <svg class="h-14 w-14 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                    </svg>
                </div>
                <h2 class="text-5xl font-black text-white mb-3 drop-shadow-lg">
                    Sistema de Reservas
                </h2>
                <div class="inline-flex items-center justify-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full">
                ...
                <p class="mt-4 text-sm text-white/90 font-medium">
                    Inicia sesión para gestionar tus reservas
                </p>
            </div>

            <!-- Card del Formulario con efecto glassmorphism -->
            <div class="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8 border border-white/20 transform transition-all duration-300 hover:shadow-3xl">
            ...
            <div>
                        ...
                        <div class="relative group">
                            ...
                            <input 
                                ...
                                class="block w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ease-in-out text-gray-900 placeholder-gray-400 bg-gray-50 hover:bg-white hover:border-gray-300"
                            />
                        </div>
                        @error('email')
